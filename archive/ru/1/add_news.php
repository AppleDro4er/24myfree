...
<?php
	echo "<form style=\"margin:25px;padding:25px;\" method=\"POST\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\"><tr><td><b>Заголовок:</b></td><td><input type=\"text\" name=\"title\" style=\"width:100%\" value=\"\"></td></tr><tr><td colspan=\"2\"><b>Текст новости:</b></td></tr><tr><td colspan=\"2\"><textarea name=\"text_t\" style=\"width:100%;height:200px;\"></textarea></td></tr><tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" name=\"add\" value=\"Добавить\"></td></tr></table></form>";
	...
	$sql = "INSERT INTO newstbl VALUES (0, \"$title_t\",\"$text_t\",\"$full_date\")";
	$qur = mysql_query($sql);
	if($qur) { echo "<font color=\"green\">Запись добавлена</font>"; } else { echo "<font color=\"red\">Запись не добавлена!</font>"; }
	}	
	mysql_close();
?>
</div>
