...
<meta property="og:title" content="AppleDro4er - весело о железе">
<meta name="title" content="AppleDro4er - весело о железе">
<link rel="icon" href="/img/favicon.ico" type="image/x-icon">
<link rel="shortcut icon" href="/img/favicon.ico" type="image/x-icon">
<script type="text/javascript" src="/js/jquery.min.js"></script>
<link rel="stylesheet" href="/style.css" type="text/css" >
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,300,700&amp;subset=cyrillic-ext,vietnamese,latin-ext,latin,cyrillic" type="text/css">
<!--[if lte IE 7]>
...
<title>AppleDro4er - весело о железе</title></head>
<body class="Hardware"><div class="PromoOverlay"><a name="up"></a><div class="BottomPanel"><noindex>
...
<div class="SiteSelect"><div class="MenuItem AnimeSite LeftAlign">
<div class="NameItem"><div class="IcoLink"></div><a href="/anime/">Аниме</a></div>
<div class="RightCorner"></div></div><div class="MenuItem BooksSite">
<div class="LeftCorner"></div>
<div class="NameItem"><div class="IcoLink"></div><a href="/books/">Книги</a></div>
<div class="RightCorner"></div></div>
<div class="MenuItem GamesSite RightAlign"><div class="LeftCorner"></div>
<div class="NameItem"><div class="IcoLink"></div><a href="/games/">Игры</a></div></div>
<div class="MenuItem FilmsSite RightSecond">
<div class="RightBackCorner"></div>
<div class="NameItem"><div class="IcoLink"></div><a href="/films/">Кино</a></div>
<div class="RightCorner"></div></div><div class="HardwareSite CenterSite">
<div class="IcoLink"></div><a href="/hardware/">Железо</a></div></div>
...
<img style="display: inline;" src="/img/logo_black.png" alt="Logo" height="206px" width="206px">
<img style="display: none;" class="LogoSkew" src="/img/logo_black_skew.png" alt="Logo" height="206px" width="206px"></div>';
}else{
...
</form></div></div><div class="LogoImg"><img style="display: inline;" src="/img/logo_black.png" alt="Logo" height="206px" width="206px">
<img style="display: none;" class="LogoSkew" src="/img/logo_black_skew.png" alt="Logo" height="206px" width="206px"></div>';}
?>
</div></div>