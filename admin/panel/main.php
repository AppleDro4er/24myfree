...
<?php
if($_GET['do']=='register'){echo '<script type="text/javascript" src="jquery.validate.min.js"></script><script src="https://www.google.com/recaptcha/api.js"></script>';}
if($_GET['do']=='auth'){echo '<script type="text/javascript" src="jquery.validate.min.js"></script>';}
if($_GET['do']==''){echo '';}
?>
<title>
<?php
