...
function news(){
$sql='SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat=catbl.id_cat LEFT JOIN usertbl ON newstbl.id_author=usertbl.id_user WHERE catbl.id_raz=2 ORDER BY newstbl.col DESC LIMIT 6';
$sql_two='SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat=catbl.id_cat WHERE id_raz=2';
...
echo "<div class='PostHead' style='z-index:$kol_two'><a href=\"/$title_lower_raz/$cat_title/$id_news/\"><svg width='1130' height='640'>
<image clip-path='url(#clip-triangle_$id_news)' class='svg-image_$id_news' alt='$title' xlink:href='/view.php?id=$id_news' width='1130' height='640' /><defs><clipPath id='clip-triangle_$id_news'><polygon points='0 0,1036 0,1036 638.08,0 558.08'/></clipPath></defs></svg>
...
$kol_two=$kol_two-2;
echo "<div class='GameList'><a href=\"/$title_lower_raz/$cat_title/$id_news/\"><svg width='600' height='400'>
<image clip-path='url(#clip-triangle_$id_news)' class='svg-image_$id_news' alt='$title' xlink:href='/view.php?id=$id_news' width='600' height='400' /><defs><clipPath id='clip-triangle_$id_news'><polygon points='0 0,518 0,518 358.92,0 313.92'/></clipPath></defs></svg>
