...
function news() {
$sql = 'SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat = catbl.id_cat LEFT JOIN usertbl ON newstbl.id_author = usertbl.id_user ORDER BY newstbl.id_news DESC LIMIT 6';
$sql_two='SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat = catbl.id_cat';
