...
function news() {
$sql='SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat=catbl.id_cat LEFT JOIN usertbl ON newstbl.id_author=usertbl.id_user WHERE catbl.id_raz=1 ORDER BY newstbl.col DESC LIMIT 6';
$sql_two='SELECT * FROM newstbl LEFT JOIN catbl ON newstbl.id_cat=catbl.id_cat WHERE id_raz=1';
...
<image clip-path='url(#clip-triangle_$id_news)' class='svg-image_$id_news' alt='$title' xlink:href='/view.php?id=$id_news' width='1130' height='640' />
<defs>
...
<image clip-path='url(#clip-triangle_$id_news)' class='svg-image_$id_news' alt='$title' xlink:href='/view.php?id=$id_news' width='600' height='400' />
<defs>
<clipPath id='clip-triangle_$id_news'>
