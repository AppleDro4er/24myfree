...
if($_GET['provider']=='vk'){
if(isset($_GET['code'])){
$client_id='5449879';$client_secret='tTgiwzpiTW7WblGInFPZ';$redirect_uri='http://24myfree.ru/login/?do=social%26provider%3Dvk';$result=false;
...
$birthday=mktime(0,0,0,$month,$day+1,$year);
...
$_SESSION['session_username']=mb_strtolower($explode);echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET vk='$uid',last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?message=ошибка-у-вк";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?message=ошибка-у-вк";window.close();</script>';}
}
if($_GET['provider']=='google'){
if(isset($_GET['code'])){
$client_id='415167080739-a0j01p0ej3plh4jma986kr6de46b2tl7.apps.googleusercontent.com';$client_secret='6fphmzP1g5-bxRYA9fNFN4_2';$redirect_uri='http://24myfree.ru/login/?do=social%26provider%3Dgoogle';$result=false;
...
$_SESSION['session_username']=mb_strtolower($explode);echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET google='$uid',last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?message=ошибка-у-гугл";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?message=ошибка-у-гугл";window.close();</script>';}
}
if($_GET['provider']=='yandex'){
if(isset($_GET['code'])){
$client_id='1f3b88c2878a4695a1ef60989fdf1b14';$client_secret='7e26c39c5d6e425bb6f5e1478291dbb3';$redirect_uri='http://24myfree.ru/login/?do=social%26provider%3Dyandex';$result=false;
...
$_SESSION['session_username']=mb_strtolower($explode);echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET yandex='$uid',last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?do=register&message=ошибка-у-яндекс";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?do=register&message=ошибка-у-яндекс";window.close();</script>';}
}
if($_GET['provider']=='mail'){
if(isset($_GET['code'])){
$client_id='744082';$client_secret='e98ba346a3c5057cf6304156a1b5481f';$redirect_uri='http://24myfree.ru/login/?do=social%26provider%3Dmail';$result=false;
...
$_SESSION['session_username']=mb_strtolower($explode);echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET mail='$uid',last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{$_SESSION['session_username']=mb_strtolower($explode);$qur=mysql_query("UPDATE usertbl SET last_login='$reg_time' WHERE email='$email'");echo '<script>opener.window.location="http://24myfree.ru/login/";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?do=register&message=ошибка-у-мэйл";window.close();</script>';}
}else{echo '<script>opener.window.location="http://24myfree.ru/login/?do=register&message=ошибка-у-мэйл";window.close();</script>';}
}
/*
