...
$qur=mysql_query("SELECT LOWER(username), password FROM usertbl WHERE username='$strtolower'");
while($rez=mysql_fetch_assoc($qur)){$hash=$rez['password'];$username=$rez['username'];}
